...
public class PushPopLayerRenderFeature : ScriptableRendererFeature
{
    ...
    public UnityEngine.Material blendMaterial;
    ...
    class PushLayerRenderPass : ScriptableRenderPass
    {
        ...
        public UnityEngine.Material blendMaterial { get; set; }
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            desc.clearColor = new Color(1.0f, 1.0f, 1.0f, 1.0f); // set the color of new render target -- play around with this like = (1f, 0.0f, 0.0f, 1.0f)
